...
<div class="fixed left-0 top-0 w-64 h-full bg-white shadow-lg z-50">
    ...
    <div class="flex items-center px-6 h-16 border-b border-gray-100">
        <img src="{{ asset('images/cesrh.png') }}" alt="Logo" class="w-[150px] h-7 mr-3">
        <!-- <span class="text-gray-700 text-lg font-semibold">CESRH</span> -->
    </div>
    ...
    <div class="h-[calc(100vh-4rem)] overflow-y-auto">
        <nav class="px-4 py-4">
            ...
            <div class="mt-6">
                ...
                <!-- Usuarios Section -->
                <div class="mt-3">
                    <button onclick="toggleUsuarios()" class="w-full flex items-center justify-between px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                        ...
                        <svg id="usuariosIcon" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>

                    <div id="usuariosMenu" class="hidden mt-1 ml-4">
                        <a href="{{ route('portal360.mostrarUser') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('portal360.mostrarRoles') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-6">
                ...
                <!-- Usuarios Section -->
                <div class="mt-3">
                    <button onclick="toggleEncuesta()" class="w-full flex items-center justify-between px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <svg id="usuariosIcondev" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400 transform transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>

                    <div id="usuariosMenudev" class="hidden mt-1 ml-4">
                        <a href="{{ route('portal360.mostrarPregunta') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('portal360.mostrarEncuestaDev') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="{{ route('portal360.mostrarAsignacion') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<!-- <a href="{{ route('portal360.mostrarRoles') }}" class="flex items-center px-4 py-3 mt-2 text-gray-300 hover:bg-gray-700 rounded-lg transition duration-200 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                    </svg>
                    Roles
                </a>
                <a href="#" class="flex items-center px-4 py-3 mt-2 text-gray-300 hover:bg-gray-700 rounded-lg transition duration-200 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
                ...
                <a class="text-white">Encuesta</a>
                <a href="" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-lg transition duration-200 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
