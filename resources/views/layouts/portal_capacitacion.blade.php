...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <h2 class="font-bold text-lg">PORTAL <span
                    class="bg-[#261fa7] text-white px-2 rounded-md">CAPACITACIÓN</span></h2>
        </a>
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                @can('Mostrar Perfil Puesto')<a href="#"
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class='bx bx-list-ul mr-3 text-lg'></i>
                    <span class="text-sm">Perfil de Puesto</span>
                    <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                </a>@endcan
                @can('Mostrar Perfil Puesto Empresa')<a href="#"
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class='bx bx-list-ul mr-3 text-lg'></i>
                    <span class="text-sm">Perfil de Puesto</span>
                    <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                </a>@endcan
                @can('Mostrar Perfil Puesto Sucursal')<a href="#"
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <i class='bx bx-list-ul mr-3 text-lg'></i>
                    <span class="text-sm">Perfil de Puesto</span>
                    <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    @can('Mostrar Perfil Puesto')
                        <li class="mb-4">
                            <a href="{{ route('mostrarPerfilPuesto') }}"
                    ...
                    @can('Mostrar Funciones Especificas')
                        <li class="mb-4">
                            <a href="{{ route('mostrarFuncionesEspecificas') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Funciones
                                Especificas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Relaciones Internas')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesInternas') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Internas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Relaciones Externas')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesExternas') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Externas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Responsabilidades Universales')
                        <li class="mb-4">
                            <a href="{{ route('mostrarResponsabilidadesUniversales') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Responsabilidades
                                Universales</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Habilidades Humanas')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesHumanas') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                humanas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Habilidades Tecnicas')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesTecnicas') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                técnica</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Perfil Puesto Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarPerfilPuestoEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                Perfil de Puesto</a>
                        </li>
                    @endcan
                    @can('Mostrar Funciones Especificas Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarFuncionesEspecificasEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Funciones
                                Especificas</a>
                        </li>
                    @endcan
                    @can('Mostrar Relaciones Internas Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesInternasEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Internas</a>
                        </li>
                    @endcan
                    @can('Mostrar Relaciones Externas Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesExternasEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Externas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Responsabilidades Universales Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarResponsabilidadesUniversalesEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Responsabilidades
                                Universales</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Habilidades Humanas Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesHumanasEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                humanas</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Habilidades Tecnicas Empresa')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesTecnicasEmpresa') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                técnica</a>
                        </li>
                    @endcan
                    ...
                    @can('Mostrar Perfil Puesto Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarPerfilPuestoSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                Perfil de Puesto</a>
                        </li>
                    @endcan
                    @can('Mostrar Funciones Especificas Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarFuncionesEspecificasSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Funciones
                                Especificas</a>
                        </li>
                    @endcan
                    @can('Mostrar Relaciones Internas Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesInternasSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Internas</a>
                        </li>
                    @endcan
                    @can('Mostrar Relaciones Externas Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarRelacionesExternasSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Relaciones
                                Externas</a>
                        </li>
                    @endcan
                    @can('Mostrar Responsabilidades Universales Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarResponsabilidadesUniversalesSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Responsabilidades
                                Universales</a>
                        </li>
                    @endcan
                    @can('Mostrar Habilidades Humanas Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesHumanasSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                humanas</a>
                        </li>
                    @endcan
                    @can('Mostrar Habilidades Tecnicas Sucursal')
                        <li class="mb-4">
                            <a href="{{ route('mostrarHabilidadesTecnicasSucursal') }}"
                                class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Habilidades
                                técnica</a>
                        </li>
                    @endcan
            ...
            <li class="mb-1 group">
                ...
                @can('Mostrar Usuarios Empresa')
                    <a href="{{ route('mostrarUsuariosEmpresa') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <i class='bx bx-user mr-3 text-lg'></i>
                        <span class="text-sm">Users</span>
                    </a>
                ...
                @can('Mostrar Usuarios Sucursal')
                    <a href="{{ route('mostrarUsuariosSucursal') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <i class='bx bx-user mr-3 text-lg'></i>
                        <span class="text-sm">Users</span>
                    </a>
                ...
                @can('Mostrar Usuarios Trabajador')
                    <a href="{{ route('mostrarUsuariosTrabajador') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <i class='bx bx-user mr-3 text-lg'></i>
            ...
            <li class="mb-1 group">
                @can('Asociar Puesto Trabajador')
                    <a href="{{ route('asociarPuestoTrabajador') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                ...
                @can('Asociar Puesto Trabajador Empresa')
                    <a href="{{ route('asociarPuestoTrabajadorEmpresa') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <i class='bx bx-archive mr-3 text-lg'></i>
                        <span class="text-sm">Asociar un Perfil de Puesto</span>
                    </a>
                ...
                @can('Asociar Puesto Trabajador Sucursal')
                    <a href="{{ route('asociarPuestoTrabajadorSucursal') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <i class='bx bx-archive mr-3 text-lg'></i>
                        <span class="text-sm">Asociar un Perfil de Puesto</span>
                    </a>
                ...
                @can('Ver capacitaciones')
                    <a href="{{ route('verCapacitacionesGru') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                ...
                @can('Ver capacitaciones Empresa')
                    <a href="{{ route('verCapacitacionesGruEmpresa') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('Ver capacitaciones Sucursal')
                    <a href="{{ route('verCapacitacionesGruSucursal') }}"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul class="mt-4">
                <li class="mb-1 group">
                    ...
                    @can('Ver cursos Sucursal')<a href="#"
                        class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                        @can('Ver cursos')
                            <li class="mb-4">
                                <a href="{{ route('verCursos') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Cursos</a>
                            </li>
                        @endcan

                        @can('Ver cursos Empresa')
                            <li class="mb-4">
                                <a href="{{ route('verCursosEmpresa') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Cursos Empresa</a>
                            </li>
                        @endcan

                        @can('Ver cursos Sucursal')
                            <li class="mb-4">
                                <a href="{{ route('verCursosSucursal') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Cursos Sucursal</a>
                            </li>
                        @endcan
                        ...
                        @can('Ver tematicas')
                            <li class="mb-4">
                                <a href="{{ route('verTematicas') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Tematicas</a>
                            </li>
                        @endcan

                        @can('Ver tematicas Empresa')
                            <li class="mb-4">
                                <a href="{{ route('verTematicasEmpresa') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Tematicas Empresa</a>
                            </li>
                        @endcan

                        @can('Ver tematicas Sucursal')
                            <li class="mb-4">
                                <a href="{{ route('verTematicasSucursal') }}"
                                    class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Ver
                                    Tematicas Sucursal</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <button type="button" class="dropdown-toggle flex items-center">
                        ...
                        <div class="p-2 md:block text-left">
                            ...
                            <p class="text-xs text-gray-500">
                                {{ Auth::user()->getRoleNames()->first() }} <!-- Mostrar el primer rol -->
                            </p>                            
                        </div>
                    </button>
                    <ul
