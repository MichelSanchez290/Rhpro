...
<div>
    ...
    <table class="table">
        <tr>
            ...
            <td> {{ $trabajador->clave_trabajador }}</td>
        </tr>
        <tr>
            <th>NSS</th>
            <td> +52 | {{ $trabajador->numero_seguridad_social }}</td>
        ...
        <tr>
            ...
            <td>{{ $trabajador->lugar_nacimiento }}</td>
        </tr>
        <tr>
            <th>Colonia</th>
            <td>{{ $trabajador->colonia }}</td>
            <th>Código Postal</th>
        ...
        <tr>
            ...
            <td>+52 | {{ $trabajador->numero_celular }}</td>
        </tr>
        <tr>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>{{ $trabajador->tipo_personal }}</td>
        </tr>
        <tr>
            <th>Ocupación</th>
            <td>{{ $trabajador->ocupacion }}</td>
            <th>Tipo de puesto</th>
            <td>{{ $trabajador->tipo_puest }}</td>
        </tr>
        <tr>
            <th>Contratación</th>
            <td>{{ $trabajador->contratacion }}</td>
            <th>Tipo de personal</th>
            <td>{{ $trabajador->tipo_personal }}</td>
        </tr>
        <tr>
            <th>Jornada de trabajo</th>
            <td>{{ $trabajador->jornada_trabajo }}</td>
            <th>Rotación de turno</th>
            <td>{{ $trabajador->rotacion }}</td>
        </tr>
        <tr>
            <th>Experiencia</th>
            <td>{{ $trabajador->experiencia }}</td>
            <th>Tiempo en el puesto</th>
            <td>{{ $trabajador->tiempo_puesto }}</td>
        </tr>
        <tr>
            <th>Contratación</th>
            <td>{{ $trabajador->contratacion }}</td>
