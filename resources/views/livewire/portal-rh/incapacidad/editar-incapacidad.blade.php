    ...
    <div class="flex min-h-screen items-center justify-center py-3">
        <div class="grid bg-white rounded-lg shadow-xl w-full">
            ...
            <div class="flex justify-center">
                <div class="flex">
                    <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Editar Incapacidad o Permiso</h1>
                </div>
            </div>
                    ...
                    @if (session()->has('message'))
                        <div x-data="{ show: true }" x-init="setTimeout(() => {
                            ...
                            <div class="flex-1">
                                ...
                                @if (session('message') == 'Incapacidad actualizada.')
                                    <p class="text-sm">La incapacidad ha sido actualizada correctamente.</p>
                                @endif
                            </div>
            ...
            <form class="mt-5 mx-7">
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <select wire:model.defer="tipo" id="tipo"
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <textarea wire:model.defer="motivo" id="motivo" rows="4" placeholder="Describe el motivo"
                ...
                <div class="flex flex-col items-center mt-5">
                    ...
                    <div class="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-dashed border-blue-400 bg-white p-6 text-center"
                        ...
                        <input type="file" id="fileInput" class="hidden" wire:model="subirPdf"
                            accept=".pdf" />
                ...
                <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                    <button type="button" wire:click="actualizarIncapacidad"
