<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Gestión de Incapacidades y Permisos</h1>
        ...
        @can('Agregar Incapacidad')
            <button wire:click="redirigir" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded">
                Solicitar Incapacidad o Permiso
            </button>
        @endcan
            ...
            @if (session()->has('message'))
                <div x-data="{ show: true }" x-init="setTimeout(() => {
                    ...
                    <div class="flex-1">
                        ...
                        @if (session('message') == 'Incapacidad Eliminada.')
                            <p class="text-sm">La incapacidad ha sido eliminada correctamente</p>
                        @endif
                    </div>
    ...
    <livewire:portalrh.incapacidad.incapacidad-table/>
