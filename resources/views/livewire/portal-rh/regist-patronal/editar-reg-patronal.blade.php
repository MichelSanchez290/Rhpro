<div class="flex min-h-screen items-center justify-center py-3">
    <div class="grid bg-white rounded-lg shadow-xl w-full">
        ...
        <div class="flex justify-center">
            <div class="flex">
                <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Actualizar Registro Patronal</h1>
            </div>
        </div>
        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="registro_patronal" type="text" id="registro_patronal"
                        placeholder="Registro Patronal"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" 
                    />
    
                    <x-input-error for="registro_patronal" />
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="nombre_o_razon_social" type="text" id="nombre_o_razon_social" 
                        placeholder="Nombre o razon social"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="nombre_o_razon_social" />
                </div>
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="regimen_capital" type="text" id="regimen_capital"
                        placeholder="Regimen capital"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="regimen_capital" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="regimen_fiscal" type="text" id="regimen_fiscal"
                        placeholder="Regimen fiscal"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="regimen_fiscal" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="actividad_economica" type="text" id="actividad_economica" 
                        placeholder="Actividad Economica"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="actividad_economica" />
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imss_calle_manzana" type="text" id="imss_calle_manzana"
                        placeholder="Calle del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imss_calle_manzana" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_num_exterior" type="text" id="imms_num_exterior"
                        placeholder="Número exterior de calle del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_num_exterior" />
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_num_int" type="text" id="imms_num_int"
                        placeholder="Número interior de calle del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_num_int" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_colonia" type="text" id="imms_colonia"
                        placeholder="Colonia"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_colonia" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_codigo_postal" type="text" id="imms_codigo_postal"
                        placeholder="Código postal del IMMS (5 digitos)"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_codigo_postal" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_estado" type="text" id="imms_estado"
                        placeholder="Estado de la república donde se encuentra el IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_estado" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_municipio" type="text" id="imms_municipio"
                        placeholder="Municipio donde se encuentra el IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_municipio" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_telefono" type="text" id="imms_telefono"
                        placeholder="Número de telefono a 10 digitos"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_telefono" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_convenio_rembolso_subsidios" type="text" id="imms_convenio_rembolso_subsidios"
                        placeholder="Convenio o Reembolso de subsidios del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_convenio_rembolso_subsidios" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="imms_tipo_contribucion" type="text" id="imms_tipo_contribucion"
                        placeholder="Tipo de contribución del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="imms_tipo_contribucion" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="area_geografica" type="text" id="area_geografica"
                        placeholder="Área Geografica del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="area_geografica" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="delegacion_imms" type="text" id="delegacion_imms"
                        placeholder="Nombre de la delegación"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="delegacion_imms" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="subdelegacion_imms" type="text" id="subdelegacion_imms"
                        placeholder="Nombre de la subdelegación"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="subdelegacion_imms" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="prima_año" type="text" id="prima_año"
                        placeholder="Prima anual del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="prima_año" />
                </div> 
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="prima_mes" type="text" id="prima_mes"
                        placeholder="Prima mensual del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="prima_mes" />
                </div> 
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="porcentaje_prima_rt" type="text" id="porcentaje_prima_rt"
                        placeholder="Porcentaje de prima RT del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="porcentaje_prima_rt" />
                </div> 
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="clase_riesgo_trabajo" type="text" id="clase_riesgo_trabajo"
                        placeholder="Clase de riesgo de trabajo del IMMS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="clase_riesgo_trabajo" />
                </div> 
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="acreditacion_stps" type="text" id="acreditacion_stps"
                        placeholder="Acreditación STPS"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="acreditacion_stps" />
                </div> 
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="puesto_representante" type="text" id="puesto_representante"
                        placeholder="Puesto del representante"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    />

                    <x-input-error for="puesto_representante" />
                </div> 
            </div>
            ...
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                ...
                <button type="button" wire:click="actualizarRegistro"
