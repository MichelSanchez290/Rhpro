<div class="p-6">
            ...
            @if (session()->has('message'))
                <div x-data="{ show: true }" x-init="setTimeout(() => {
                    ...
                    <div class="flex-1">
                        ...
                        @if (session('message') == 'Registro Patronal Eliminado.')
                            <p class="text-sm">El Registro Patronal ha sido eliminado correctamente</p>
                        @endif
                    </div>
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">
                    ¿Está seguro de que desea eliminar este Registro Patronal
                </h3>
    ...
    <livewire:portalrh.registpatronal.reg-patronal-table/>
