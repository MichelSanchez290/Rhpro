<div class="flex min-h-screen items-center justify-center py-3">
    <div class="grid bg-white rounded-lg shadow-xl w-full">
        ...
        <div class="flex justify-center">
            <div class="flex">
                <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Agregar Crédito Infonavit</h1>
            </div>
        </div>
            ...
            <div class="flex items-center justify-between">
                @if (session()->has('message'))
                    <div x-data="{ show: true }" x-init="setTimeout(() => {
                        show = false;
                        window.location.href = '{{ route('mostrarinfonavit') }}'
                    }, 5000)" x-show="show"
                        ...
                        <div class="flex-1">
                            ...
                            @if (session('message') == 'Crédito Infonavit Agregado.')
                                <p class="text-sm">El crédito infonavit fue agregado al historial del usuario correctamente</p>
                            @endif
                        </div>
        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                ...
                <!--  -->
                <div class="grid grid-cols-1 mt-5">
                    <label for="user_id" class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">
                        Usuarios</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="infonavit.tipo_movimiento" type="text"
                        id="tipo_movimiento" placeholder="Tipo de movimiento"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="infonavit.tipo_movimiento" />
                </div>

                <div class="grid grid-cols-1 mt-5">
                    <label for="numero_credito"
                        class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">
                        Número de crédito
                    </label>
                    <input wire:model.defer="infonavit.numero_credito" type="text"
                        id="numero_credito" placeholder="Número de crédito"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="infonavit.numero_credito" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="infonavit.fecha_movimiento" type="date" id="fecha_movimiento"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />


                    <x-input-error for="infonavit.fecha_movimiento" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="infonavit.tipo_descuento" type="text" id="tipo_descuento"
                        placeholder="Tipo de descuento"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="infonavit.tipo_descuento" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 mt-5">
                ...
                <input wire:model.defer="infonavit.valor_descuento" type="text" id="valor_descuento"
                    placeholder="Valor de descuento"
                    class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                <x-input-error for="infonavit.valor_descuento" />
            </div>

            <!-- Botones -->
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                <button type="button" wire:click="saveInfonavit"
                    class='w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>
                    Agregar
                </button>

                <button type="button" wire:click="redirigirInfonavit"
