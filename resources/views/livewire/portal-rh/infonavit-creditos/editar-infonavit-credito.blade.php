                ...
                @if (session()->has('message'))
                    <div x-data="{ show: true }" x-init="setTimeout(() => {
                        ...
                        <div class="flex-1">
                            ...
                            @if (session('message') == 'Credito Infonavit Actualizado.')
                                <p class="text-sm">El crédito infonavit ha sido actualizado correctamente</p>
                            @endif
                        </div>
        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="tipo_movimiento" type="text"
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="numero_credito" type="text"
                        id="numero_credito" placeholder="Número de crédito"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="numero_credito" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="fecha_movimiento" type="date" id="fecha_movimiento"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />


                    <x-input-error for="fecha_movimiento" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="tipo_descuento" type="text" id="tipo_descuento"
                        placeholder="Tipo de descuento"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="tipo_descuento" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 mt-5">
                ...
                <input wire:model.defer="valor_descuento" type="text" id="valor_descuento"
                    placeholder="Valor de descuento"
                    class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                <x-input-error for="valor_descuento" />
            </div>

            <!-- Botones -->
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                <button type="button" wire:click="actualizarInfonavit"
