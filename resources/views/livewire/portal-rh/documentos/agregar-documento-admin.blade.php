        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="documento.fecha_subida" type="date" id="fecha_subida"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />


                    <x-input-error for="documento.fecha_subida" />
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <select wire:model.defer="documento.status" id="status"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                        <option value="" selected>-- Selecciona una opción --</option>
                    ...
                    <x-input-error for="documento.status" />
                </div>
            ...
            <div class="grid grid-cols-1 mt-5">
                ...
                <textarea wire:model.defer="documento.comentarios" id="comentarios" rows="4"
                ...
                <x-input-error for="documento.comentarios" />
            </div>

            <div class="flex flex-col items-center mt-5">
                <label for="archivo" class="uppercase text-lg md:text-xl text-gray-600 font-semibold mb-4">
                    Documento
                </label>
                ...
                <div class="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-dashed border-blue-400 bg-white p-6 text-center"
                    ...
                    <input type="file" id="fileInput" class="hidden" wire:model.defer="archivo"
                        accept=".pdf" />
            ...
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                <button type="button" wire:click="saveDoc"
                    class='w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>
                    Agregar
                </button>

                <button type="button" wire:click="redirigirDoc"
