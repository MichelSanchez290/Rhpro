<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Gestión de Documentos</h1>
            ...
            @if (session()->has('message'))
                <div x-data="{ show: true }" x-init="setTimeout(() => {
                    ...
                    <div class="flex-1">
                        ...
                        @if (session('message') == 'Documento Eliminado.')
                            <p class="text-sm">El documento ha sido eliminado correctamente</p>
                        @endif
                    </div>
    ...
    <livewire:portalrh.documentos.documento-table/>
