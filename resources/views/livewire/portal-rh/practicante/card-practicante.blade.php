    ...
    <div class="bg-white rounded-lg shadow-xl pb-8">
        ...
        <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
            <div class="flex items-center space-x-4 mt-2">
                ...
                <button wire:click.prevent="generatePDF({{ $practicante->id }})" wire:loading.attr="disabled"
                            ...
                            @foreach ($retardos as $retardo)
                                <div class="w-full mx-auto bg-white shadow-xl rounded-lg text-gray-900 p-4">
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <p><strong>Hora programada: </strong> {{ $retardo->hora_entrada_programada }}
                                        </p>
                            ...
                            @foreach ($cambio_salarios as $cambio_salario)
                                <div class="w-full mx-auto bg-white shadow-xl rounded-lg text-gray-900 p-4">
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <p><strong>Salario anterior: </strong> {{ $cambio_salario->salario_anterior }}
                                        </p>
