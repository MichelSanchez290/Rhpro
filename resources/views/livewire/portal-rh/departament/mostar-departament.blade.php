<div class="p-6 ">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Gestión de Departamentos</h1>
            ...
            @if (session()->has('message'))
                <div x-data="{ show: true }" x-init="setTimeout(() => {
                    ...
                    <div class="flex-1">
                        ...
                        @if (session('message') == 'Departamento Eliminado.')
                            <p class="text-sm">El departamento ha sido eliminado correctamente</p>
                        @endif
                    </div>
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">
                    ¿Está seguro de que desea eliminar este Departamento?</h3>
                <button wire:click="deleteDepa"
    ...
    <div >
        <livewire:portalrh.departament.departament-table/>
    </div>
