    ...
    <div class="grid bg-white rounded-lg shadow-xl w-full">
                ...
                @if (session()->has('message'))
                    <div x-data="{ show: true }" x-init="setTimeout(() => {
                        ...
                        <div class="flex-1">
                            ...
                            @if (session('message') == 'Empresa Actualizada.')
                                <p class="text-sm">La Empresa ha sido actualizada correctamente</p>
                            @endif
                        </div>
        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1">
                    <label for="razon_social"
                        ...
                        Social</label>
                    <input wire:model.defer="razon_social" type="text" id="razon_social" placeholder="Razón social"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />
            ...
            <div class="flex flex-col md:flex-row gap-5 mt-5">
                ...
                <!-- Logo de la empresa -->
                <div class="flex flex-col items-center w-full md:w-1/2">
                    <label for="subirImg" class="uppercase text-lg md:text-xl text-gray-600 font-semibold mb-4">
                        Logo de la empresa
                    </label>
                    ...
                    <div class="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-dashed border-green-400 bg-white p-6 text-center"
                        ...
                        <!-- Input oculto, activado al hacer clic -->
                        <input type="file" id="logoInput" class="hidden" wire:model="subirImg"
                            accept=".png,.jpg,.jpeg" />

                        <br>

                        @if ($subirImg)
                            <img src="{{ $subirImg->temporaryUrl() }}" width="100" height="100"
