        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="baja.fecha_baja" type="date" id="fecha_baja"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />

                    <x-input-error for="baja.fecha_baja" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <select wire:model.defer="baja.tipo_baja" id="tipo_baja"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                    ...
                    <x-input-error for="baja.tipo_baja" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 mt-5">
                ...
                <textarea wire:model.defer="baja.motivo_baja" id="motivo_baja" rows="4" placeholder="Describe el motivo"
                ...
                <x-input-error for="baja.motivo_baja" />
            </div>
            ...
            <div class="grid grid-cols-1 mt-5">
                ...
                <textarea wire:model.defer="baja.observaciones" id="observaciones" rows="4"
                    placeholder="Añade tus observaciones de ser necesario"
                    class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent resize-y">
                </textarea>

                <x-input-error for="baja.observaciones" />
            </div>
            ...
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                <button type="button" wire:click="saveBaja"
                    class='w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>
                    Agregar
                </button>

                <button type="button" wire:click="redirigirBaja"
