        ...
        <form class="mt-5 mx-7">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="retardo.fecha" type="date" id="fecha_inicio"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />


                    <x-input-error for="retardo.fecha" />
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="retardo.hora_entrada_programada" type="text" id="hora_entrada_programada"
                        placeholder="8:00 AM"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"/>

                    <x-input-error for="retardo.hora_entrada_programada" /> 
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="retardo.hora_entrada_real" type="text" id="hora_entrada_real"
                        placeholder="8:23 AM"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"/>

                    <x-input-error for="retardo.hora_entrada_real" /> 
                </div>
                ...
                <div class="grid grid-cols-1 mt-5">
                    ...
                    <input wire:model.defer="retardo.minutos_retardo" type="text" id="minutos_retardo"
                        placeholder="23 minutos"
                        class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"/>

                    <x-input-error for="retardo.minutos_retardo" /> 
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <x-input-error for="retardo.status" />
            ...
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5'>
                <button type="button" wire:click="saveRetardo"
                    class='w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>
                    Agregar
                </button>

                <button type="button" wire:click="redirigirRetardo"
