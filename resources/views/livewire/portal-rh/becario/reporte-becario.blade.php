...
<div>
    ...
    <table class="table">
        <tr>
            ...
            <th>Clave del Becario</th>
            <td>{{ $becario->clave_becario ?? 'No disponible' }}</td>
        </tr>
        <tr>
            <th>NSS</th>
            <td>{{ $becario->numero_seguridad_social }}</td>
            <th>Fecha de Nacimiento</th>
            <td>{{ $becario->fecha_nacimiento }}</td>
        </tr>
        <tr>
            <th>Lugar de Nacimiento</th>
            <td>{{ $becario->lugar_nacimiento }}</td>
            <th>Estado</th>
            <td>{{ $becario->estado }}</td>
        </tr>
        <tr>
            <th>Colonia</th>
            <td>{{ $becario->colonia }}</td>
            <th>Calle</th>
            <td>{{ $becario->calle }}</td>
        </tr>
        <tr>
            <th>Código Postal</th>
            <td>{{ $becario->codigo_postal }}</td>
            <th>Ocupacion</th>
            <td>{{ $becario->ocupacion }}</td>
        </tr>
        <tr>
            <th>CURP</th>
            <td>{{ $becario->curp }}</td>
        ...
        <tr>
            <th>Teléfono</th>
            <td>+52 | {{ $becario->numero_celular }}</td>
            <th>Status</th>
            <td><span
                    class="status {{ $becario->status === 'Activo' ? 'status-aprobada' : 'status-rechazada' }}">{{ $becario->status }}</span>
            </td>
        </tr>
    </table>
