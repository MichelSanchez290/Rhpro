    ...
    <div class="container px-4 mx-auto mt-6">
        ...
        <div class="flex flex-wrap mb-6 -mx-2">
            <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                ...
                <input
                    class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                    wire:model.defer="empresa.tamano_empresa" type="text" placeholder="">
                <x-input-error for="empresa.tamano_empresa" />
            </div>
            <div class="w-full px-3 md:w-1/2">
        ...
        <div class="flex flex-wrap mb-6 -mx-2">
            ...
            <div class="w-full px-3 md:w-1/2">
                ...
                <input
                    class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                    wire:model="pruebadeimagen" type="file" placeholder="">
                <x-input-error for="pruebadeimagen" />
            </div>
        </div>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div class="image-container">
                <label
                    ...
                    <input type="file" class="hidden" wire:model="img" accept="image/png, image/jpeg" />
                    <br>
                    {{-- @if (empty($subirLogo))
                    @else
                    <img src="{{ $subirLogo->temporaryUrl() }}" width="100"
                    height="100" alt="Logo" />
                    @endif --}}
                    <x-input-error for="img" />
                </label>
            </div>
        </div>
        <!-- Botón -->
