    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-white shadow-xl rounded-xl p-6 border border-gray-100 transition-all duration-300 hover:shadow-md">
            ...
            <header class="mb-6 text-center">
                <h2 class="text-2xl font-bold text-blue-800">Agregar Encuesta</h2>
                <p class="mt-2 text-sm text-gray-600">Complete el formulario para crear una nueva encuesta.</p>
            </header>
