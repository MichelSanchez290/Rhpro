    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-700">Complete los campos en orden: primero seleccione la sucursal, luego la encuesta, y finalmente la pregunta.</p>
            </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-1">
                        ...
                        <div>
                            ...
                            <!-- <pre>{{ json_encode($preguntas->toArray(), JSON_PRETTY_PRINT) }}</pre> -->
