<div>
    <div class="p-6">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="relative">
                <button wire:click="redirigirpreguntaEmpresa()" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow mb-4 absolute top-3 left-10">Agregar Pregunta</button>
            </div>
