<div>
    <div class="bg-white shadow-md rounded-lg p-6 mx-4 my-6">
        <p class="text-center text-xl font-extrabold text-black md:text-3xl">
            Agregar Asignación en Sucursal
        </p>
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="mb-6">
                ...
                <select 
                    ...
                    @class([
                        'w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                        'bg-gray-100' => empty($tipo_user_calificador)
                    ])
            ...
            <div class="mb-6">
                ...
                <select 
                    id="tipo_user_calificado"
                    wire:model.live="tipo_user_calificado"
                    @class([
                        'w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                        'bg-gray-100' => empty($calificador_id)
                    ])
            ...
            <div class="mb-6">
                ...
                <select 
                    ...
                    @class([
                        'w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                        'bg-gray-100' => empty($tipo_user_calificado)
                    ])
            ...
            <div class="mb-6">
                ...
                <select 
                    ...
                    @class([
                        'w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                        'bg-gray-100' => empty($calificado_id)
                    ])
