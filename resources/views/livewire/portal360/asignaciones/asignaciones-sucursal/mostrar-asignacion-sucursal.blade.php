    ...
    <div class="p-6">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="absolute right-20">
                <button wire:click="redirigirAsignacionSucursal()"
            ...
            <div class="overflow-x-auto rounded-md mt-16"> <!-- Aumenta el valor de 'mt-8' si lo quieres más abajo -->
                <livewire:portal360.asignaciones.asignacionessucursal.asignaciones-sucursal-table class="table-borderless" />
            </div>
        </div>
    </div>
</div>
        ...
        Livewire.on('confirmarEliminarAsignacionSucursal', (data) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarAsignacionSucursal', {
                        id: data.id
                    });
                }
            });
