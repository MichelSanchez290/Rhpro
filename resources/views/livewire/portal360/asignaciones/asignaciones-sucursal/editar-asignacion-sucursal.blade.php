<div>
    <div class="bg-white shadow-md rounded-lg p-6 mx-4 my-6">
        ...
        <div class="mb-6">
            ...
            <span class="text-red-500สุ text-sm">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="flex space-x-4">
            <a href="{{ route('portal360.asignaciones.asignaciones-sucursal.mostrar-asignacion-sucursal') }}"
