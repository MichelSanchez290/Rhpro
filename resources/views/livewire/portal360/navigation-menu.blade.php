            ...
            <div class="mt-6">
                ...
                <div class="mt-3">
                    ...
                    <div class="submenu {{ $isEncuestasOpen ? 'block' : '' }} mt-1 ml-4 space-y-1">
                        ...
                        @endcan
                        <a href="{{ route('portal360.envaluaciones.envaluacion-administrador.mostrar-resultados-administrador') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
