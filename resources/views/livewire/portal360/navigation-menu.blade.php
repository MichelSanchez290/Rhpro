<div>
    <!-- Sidebar -->
    <div id="sidebar"
    class="fixed left-0 top-0 w-64 h-full bg-white shadow-lg z-50 transition-transform duration-300 ease-in-out {{ $isSidebarOpen ? 'translate-x-0' : '-translate-x-full' }}">
        ...
        <!-- Más contenido del menú lateral -->
        <nav class="px-4 py-4">
            <!-- Panel Section -->
              ...
              <div class="mt-6">
                ...
                <div class="mt-3">
                    ...
                    <div id="usuariosMenu" class="hidden mt-1 ml-4">
                        ...
                        <a href="{{ route('portal360.relaciones.relaciones-administrador.mostrar-relacion-administrador') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-sm">Relaciones Laborales Ad</span>
                        </a>
                        @endcan
                        ...
                        <a href="{{ route('portal360.empresa.empresa-administrador.mostrar-empresa-administrador') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            ...
                            <span class="text-sm">Empresas Ad</span>
                        </a>
                        @endcan
            ...
            <div class="mt-6">
                ...
                <div class="mt-3">
                    ...
                    <div id="usuariosMenudev" class="hidden mt-1 ml-4">
                        ...
                        <a href="{{ route('portal360.preguntas.preguntas-administrador.mostrar-preguntas-administrador') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-sm">Preguntas Ad</span>
                        </a>
                        @endcan
                        @can('Mostrar Preguntas ADMIN EMPRESA')
                        <a href="{{ route('portal360.preguntas.preguntas-empresa.mostrar-preguntas-empresa') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                            </svg>
                        ...
                        <a href="{{ route('portal360.preguntas.preguntas-sucursal.mostrar-pregunta-sucursal') }}" class="flex items-center px-3 py-2.5 text-gray-600 hover:text-gray-800 rounded-lg group transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                            </svg>
