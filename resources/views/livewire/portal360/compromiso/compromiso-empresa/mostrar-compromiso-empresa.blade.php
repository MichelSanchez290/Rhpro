    ...
    <div class="p-6">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="absolute right-20">
                <button wire:click="redirigirCompromisoEmpresa()"
            ...
            <div class="overflow-x-auto rounded-md mt-16"> <!-- Aumenta el valor de 'mt-8' si lo quieres más abajo -->
                <livewire:portal360.compromiso.compromisoempresa.compromiso-empresa-table class="table-borderless" />
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        Livewire.on('confirmarEliminarCompromisoEmpresa', (data) => {
            Swal.fire({
                title: "¿Está seguro?",
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarCompromisoEmpresa', {
                        id: data.id
                    });
                }
            });
