<div class="p-6">
    <!-- Encabezado con título y botón para agregar rol -->
    ...
    <div id="modalConfirm"
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">¿Estás seguro de que deseas eliminar este rol?</h3>
    ...
    <!-- Llamada al PowerGrid -->
    <livewire:dx035.rol.rol-table/>
</div>
