                        ...
                        @forelse ($encuestas as $encuesta)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <button wire:click="generarReporte2({{ $encuesta->id }})" class="text-red-600 hover:text-red-900 ml-2">
        ...
        function confirmarEliminacion(encuestaId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire('Eliminada!', data.success, 'success');
                            // Recargar la página para actualizar la lista de encuestas
