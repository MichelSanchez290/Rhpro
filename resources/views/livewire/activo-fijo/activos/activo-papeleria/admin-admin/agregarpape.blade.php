    ...
    <div class="h-screen overflow-y-auto">
        <div class="my-5">
            ...
            <div class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white font-bold text-xl py-4 px-6 rounded-t-lg shadow-lg">
                <h1 class="text-center text-2xl sm:text-3xl font-bold text-white">Registrar Activo de Papeleria</h1>
            </div>
            ...
            <div class="bg-white rounded-b-lg shadow-2xl p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="my-2">
                        ...
                        <select id="empresa" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" wire:model="empresaSeleccionada">
                    ...
                    <div class="my-2">
                        ...
                        <select id="sucursall" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" wire:model="activo.sucursal_id">
                    ...
                    <!-- codigo del Producto -->
                    <div class="my-2">
                        <label for="codigo_producto" class="text-gray-700 font-bold text-xl">Codigo del Producto</label>
                        <input type="text" wire:model="activo.codigo_producto" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="codigo_producto" placeholder="Ingresa el codigo del activo">
                        @error('tipos.codigo_producto') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <!-- Nombre del Producto -->
                    <div class="my-2">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" wire:model="activo.marca" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="marca" placeholder="Ingresa la marca">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" wire:model="activo.tipo" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="tipo" placeholder="Ingresa el tipo">
                        @error('activo.tipo') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    
                    <!-- Ubicación Física -->
                    <div class="my-2">
                        <label for="cantidad" class="text-gray-700 font-bold text-xl">Cantidad</label>
                        <input type="number" wire:model="activo.cantidad" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="cantidad" placeholder="Ingresa la cantidad">
                        @error('activo.cantidad') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" wire:model="activo.color" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="color" placeholder="Ingresa el color">
                ...
                <div class="flex justify-center mt-4">
                    <button wire:click="saveActivoPape()" class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white px-6 py-2 rounded-lg shadow-lg font-bold hover:bg-[#1763A6]">Guardar</button>
                </div>
            </div>
        </div>
    </div>
