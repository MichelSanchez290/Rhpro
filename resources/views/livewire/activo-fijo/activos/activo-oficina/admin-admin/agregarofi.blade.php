            ...
            <div class="bg-white rounded-b-lg shadow-2xl p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="my-2">
                        ...
                        @error('activo.nombre') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    
                    <!-- Número de Activo -->
                    <div class="my-2">
                        <label for="numero_activo" class="text-gray-700 font-bold text-xl">Número de Activo</label>
                        <input type="text" wire:model="activo.numero_activo" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="numero_activo" placeholder="Ingresa el número de activo">
                        @error('activo.numero_activo') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
