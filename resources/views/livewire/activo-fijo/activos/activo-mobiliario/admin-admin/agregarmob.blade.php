         ...
         <div class="bg-white rounded-b-lg shadow-2xl p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="my-2">
                    ...
                    <input type="text" wire:model="activo.num_serie"
                        class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black"
                        id="num_serie" placeholder="Ingresa el número de serie">
                ...
                <div class="my-2">
                    ...
                    <input type="text" wire:model="activo.num_activo"
                        class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black"
                        id="num_activo" placeholder="Ingresa el número de activo">
                ...
                <div class="my-2">
                    ...
                    <input type="text" wire:model="activo.ubicacion_fisica"
                        class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black"
                        id="ubicacion_fisica" placeholder="Ingresa la ubicación física">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div class="image-container">
                            <label
                                ...
                                <br>
                                @if ($subirfoto4)
                                    <img src="{{ $subirfoto4->temporaryUrl() }}" width="100" height="100"
                                        alt="Imagen 4" />
                                @endif
            ...
            <div class="flex justify-center mt-4">
                <button wire:click="saveActivoMob()"
