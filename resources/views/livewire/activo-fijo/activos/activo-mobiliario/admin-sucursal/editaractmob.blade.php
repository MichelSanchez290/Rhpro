<div class="h-screen overflow-y-auto">
    <div class="my-5">
        <div class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white font-bold text-xl py-4 px-6 rounded-t-lg shadow-lg">
            <h1 class="text-center text-2xl sm:text-3xl font-bold text-white">Editar Activo Mobiliario</h1>
        </div>
        ...
        <div class="bg-white rounded-b-lg shadow-2xl p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="my-2">
                    ...
                    <input type="text" wire:model="numser" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="numser">
                </div>
                <div class="my-2">
                    <label for="numact" class="text-gray-700 font-bold text-xl">Número de Activo</label>
                    <input type="text" wire:model="numact" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="numact">
                </div>
                <div class="my-2">
                    <label for="ubicacion" class="text-gray-700 font-bold text-xl">Ubicación Física</label>
                    <input type="text" wire:model="ubicacion" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="ubicacion">
                </div>
                <div class="my-2">
                ...
                <div class="my-2">
                    ...
                    <input type="number" wire:model="precioad" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="precioad">
                </div>
                ...
                <div class="my-2 sm:col-span-2">
                    ...
                    <textarea wire:model="descripcion" class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="descripcion"></textarea>
                </div>
                <div class="my-2 sm:col-span-2">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div class="image-container">
                            <label class="mx-auto cursor-pointer flex w-full flex-col items-center rounded-xl border-2 border-dashed border-blue-400 bg-white p-6 text-center shadow-md">
                                ...
                                @elseif ($foto4)
                                    <img src="{{ asset($foto4) }}" width="100" height="100" alt="Imagen 4" />
                                @endif
