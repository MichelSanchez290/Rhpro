    ...
    <div class="my-5">
        ...
        <div class="bg-white rounded-b-lg shadow-2xl p-6">
            ...
            <div class="flex justify-center mt-4">
                <button wire:click="saveActivoTec()" class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white px-6 py-2 rounded-lg shadow-lg font-bold hover:bg-[#1763A6]">Guardar</button>
            </div>
        </div>
    </div>
</div>