            ...
            <div class="bg-white rounded-b-lg shadow-2xl p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="my-2 sm:col-span-2">
                        ...
                        <textarea wire:model="activo.observaciones"
                            class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black" id="observaciones"
                            placeholder=""></textarea>
                        @error('tipos.observaciones')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
