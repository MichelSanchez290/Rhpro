    ...
    <div class="h-screen overflow-y-auto">
        <div class="my-5">
            <div class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white font-bold text-xl py-4 px-6 rounded-t-lg shadow-lg">
                <h1 class="text-center text-2xl sm:text-3xl font-bold text-white">Asignar Activo Uniforme</h1>
            </div>
            <div class="bg-white rounded-b-lg p-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="my-2">
                        <div class="py-2 my-2">
                            <label for="activo" class="text-gray-700 font-bold text-xl">Activo Uniforme</label>
                        </div>
