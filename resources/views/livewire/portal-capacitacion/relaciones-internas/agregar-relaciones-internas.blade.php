<div>
    <!-- Formulario para agregar una función específica -->
        <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Agregar Relación Interna</h2>
            ...
            <form class="space-y-4">
                ...
                <div>
                    ...
                    <select wire:model="interna.frecuencia" id="frecuencia" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
