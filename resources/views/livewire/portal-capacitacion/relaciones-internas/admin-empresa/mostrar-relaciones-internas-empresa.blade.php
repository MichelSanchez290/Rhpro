<div class="p-6 z-10">
    <div class="mt-4 flex items-center justify-between">
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-300 md:text-5xl lg:text-6xl dark:text-black">Gestión <span class="text-blue-600 dark:text-blue-500">Relaciones Internas</span></h1>
    ...
    <div class="mt-6 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
        <livewire:portalcapacitacion.relacionesinternas.admingeneral.relacion-interna-table/>
