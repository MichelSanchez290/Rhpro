<div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col justify-center h-full">
            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                ...
                <header class="px-5 py-4 border-b border-gray-100">
                    <h2 class="font-semibold text-gray-800">Relaciones Internas</h2>
                </header>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full">
                            <thead class="text-xs font-semibold uppercase text-gray-700 bg-blue-50">
                                <tr>
                                    <th class="p-3 whitespace-nowrap">
                                        <div class="font-semibold text-left">Puesto</div>
                                    </th>
                                    <th class="p-3 whitespace-nowrap">
                                        <div class="font-semibold text-left">Razón o Motivo</div>
                                    </th>
                                    <th class="p-3 whitespace-nowrap">
                                        <div class="font-semibold text-left">Frecuencia</div>
                                    </th>
                                    <th class="p-3 whitespace-nowrap">
                            ...
                            <tbody class="text-sm divide-y divide-gray-200">
                                @forelse($internas as $interna)
                                    <tr>
                                        <td class="p-3 whitespace-normal">
                                            <div class="text-gray-800">{{ $interna->puesto }}</div>
                                        </td>
                                        <td class="p-3 whitespace-normal">
                                            <div class="text-gray-800">{{ $interna->razon_motivo }}</div>
                                        </td>
                                        <td class="p-3 whitespace-normal">
                                            <div class="text-gray-800">{{ $interna->frecuencia }}</div>
                                        </td>
                                        <td class="p-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center space-x-4 cursor-pointer">
                                                <a href="{{route('editarRelacionesInternas', Crypt::encrypt($interna->id))}}" class="text-blue-600 hover:text-blue-800">Editar</a>
                                                <button wire:click="delete({{ $interna->id }})" class="text-red-600 hover:text-red-800">Eliminar</button>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
    ...
    <div class="mt-6 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
        <livewire:portalcapacitacion.relacionesinternas.relacion-interna-table/>
    </div>
