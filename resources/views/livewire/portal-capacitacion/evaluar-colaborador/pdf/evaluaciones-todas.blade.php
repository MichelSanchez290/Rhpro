...
<body>
    ...
    <div class="contenedor">
        ...
        <div style="position: absolute; top: 16cm; left: 8cm;">
            ...
            <div style="color: rgb(7, 65, 107); font-size: 15pt; font-family: 'Nourd', sans-serif;">
                Análisis de desempeño y evaluación de criterios
             </div>
    ...
    <div class="contenedor2" style="font-family: 'Nourd', sans-serif;">
        <h2 style="color: rgb(7, 65, 107); font-size: 20pt; font-weight: bold; margin-bottom: 5px; margin-top: 1cm;">Fecha de Evaluación: {{ \Carbon\Carbon::parse($fecha)->format('d/m/Y') }}</h2>
        <div style="border-top: 0.1cm solid rgb(7, 65, 107);"></div>
        <table style="font-size: 13pt; border-collapse: collapse; margin-top: 1cm; width: 90%;">
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="padding: 8px; border: 1px solid rgb(7, 65, 107);"><strong>{{ number_format($evals->avg('calificacion_desempeno'), 2) }}</strong></td>
                </tr>
                @php
                ...
                @endphp
                    <tr>
                        <td colspan="2" style="padding: 8px; border: 1px solid rgb(7, 65, 107);"><strong>Comentarios:</strong>  {{ $comentarioFinal }}</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 8px; border: 1px solid rgb(7, 65, 107);"><strong>Recomendaciones:</strong> {{ $recomendacionFinal }}</td>
                    </tr>
            </tfoot>
        </table>
    </div>    
