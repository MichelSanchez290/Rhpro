    ...
    <div class="flex flex-col justify-center h-full">
        ...
        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            ...
            <header class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-800">Relaciones universales</h2>
            </header>
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        <thead class="text-xs font-semibold uppercase text-gray-700 bg-blue-50">
                            <tr>
                                <th class="p-3 whitespace-nowrap">
                                    <div class="font-semibold text-left">Sistema</div>
                                </th>
                                <th class="p-3 whitespace-nowrap">
                                    <div class="font-semibold text-left">Responsabilidad</div>
                                </th>
                                <th class="p-3 whitespace-nowrap">
                        ...
                        <tbody class="text-sm divide-y divide-gray-200">
                            @forelse($universales as $universal)
                                <tr>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $universal->sistema }}</div>
                                    </td>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $universal->responsalidad }}</div>
                                    </td>
                                    <td class="p-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center space-x-4 cursor-pointer">
                                            <a href="{{route('editarResponsabilidadesUniversales', Crypt::encrypt($universal->id))}}" class="text-blue-600 hover:text-blue-800">Editar</a>
                                            <button wire:click="delete({{ $universal->id }})" class="text-red-600 hover:text-red-800">Eliminar</button>
                                        </div>
                                    </td>
                                </tr>
                            @empty
...
<div class="mt-6 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
    <livewire:portalcapacitacion.responsabilidadesuniversales.responsabilidad-universal-table/>
</div>
</div>
