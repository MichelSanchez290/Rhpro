        ...
        <table class="table">
          ...
          <tr>
            ...
            <td class="curp-table">
                ...
                {{ str_split($fechas->fechaIni)[0] ?? '' }} | {{ str_split($fechas->fechaIni)[1] ?? '' }} | {{ str_split($fechas->fechaIni)[2] ?? '' }} | {{ str_split($fechas->fechaIni)[3] ?? '' }}
            </td>

            <td class="curp-table">
              <strong>Mes</strong><br>
              {{ str_split($fechas->fechaIni)[5] ?? '' }} | {{ str_split($fechas->fechaIni)[6] ?? '' }}
            </td>

            <td class="curp-table">
              <strong>Día</strong><br>
              {{ str_split($fechas->fechaIni)[8] ?? '' }} | {{ str_split($fechas->fechaIni)[9] ?? '' }}
            </td>
            ...
            <td class="curp-table">
              <strong>Año</strong><br>
              {{ str_split($fechas->fechaFin)[0] ?? '' }} | {{ str_split($fechas->fechaFin)[1] ?? '' }} | {{ str_split($fechas->fechaFin)[2] ?? '' }} | {{ str_split($fechas->fechaFin)[3] ?? '' }}
            </td>

            <td class="curp-table">
              <strong>Mes</strong><br>
              {{ str_split($fechas->fechaFin)[5] ?? '' }} | {{ str_split($fechas->fechaFin)[6] ?? '' }}
            </td>

            <td class="curp-table">
              <strong>Día</strong><br>
              {{ str_split($fechas->fechaFin)[8] ?? '' }} | {{ str_split($fechas->fechaFin)[9] ?? '' }}
            </td>
          </tr>
