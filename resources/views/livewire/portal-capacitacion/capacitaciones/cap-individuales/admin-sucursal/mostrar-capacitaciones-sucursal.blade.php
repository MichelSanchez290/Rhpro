<div class="max-w-4xl px-10 my-6 py-8 bg-white rounded-lg shadow-md mx-auto relative">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <button onclick="window.location.href='{{ route('agregarCapacitacionesIndSucursal', Crypt::encrypt($userSeleccionado)) }}'" 
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-light text-gray-600"><strong>Fecha fin:
                        ...
                        <div class="flex items-center gap-0">
                            ...
                            <button onclick="window.location.href='{{ route('editarCapacitacionesIndSucursal', Crypt::encrypt($capacitacion->id)) }}'"
