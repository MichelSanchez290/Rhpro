...
<head>
    ...
    <style>
        ...
        @page {
            ...
            padding: 80px 40px 40px; /* Más espacio arriba (80px) */
            min-height: 100vh;
        ...
        /* Eliminar margen inferior de la última página */
        .page:last-child {
...
<body>
    ...
    @foreach ($capacitaciones as $capacitacion)
        <div class="tarjetasdos page-break">
            <div class="headerdos">
                <h1>Reporte de Capacitación Individual {{ $selectedYear }}</h1>
            ...
            <div class="capacitaciondos">
                ...
                <p class="otrap"><span class="bold">Ocupación:</span>
                    {{ $capacitacion->ocupacion_especifica ?? 'N/A' }}</p>
