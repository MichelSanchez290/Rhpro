    ...
    <div class="flex flex-col justify-center h-full">
        ...
        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            ...
            <header class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-800">Relaciones Externas</h2>
            </header>
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-gray-200">
                            @forelse($externas as $externa)
                                <tr>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $externa->nombre }}</div>
                                    </td>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $externa->razon_motivo }}</div>
                                    </td>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $externa->frecuencia }}</div>
                                    </td>
                                    <td class="p-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center space-x-4 cursor-pointer">
                                            <a href="{{route('editarRelacionesExternas', Crypt::encrypt($externa->id))}}" class="text-blue-600 hover:text-blue-800">Editar</a>
                                            <button wire:click="delete({{ $externa->id }})" class="text-red-600 hover:text-red-800">Eliminar</button>
                                        </div>
                                    </td>
                                </tr>
                            @empty
...
<div class="mt-6 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
    <livewire:portalcapacitacion.relacionesexternas.relacion-externa-table/>
</div>
