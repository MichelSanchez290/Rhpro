...
<section class="antialiased bg-gray-100 text-gray-600 mt-6 px-4">
    <div class="flex flex-col justify-center h-full">
        ...
        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            ...
            <header class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-800">Formaciones Habilidades Humanas</h2>
            </header>
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-gray-200">
                            @forelse($humanas as $humana)
                                <tr>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $humana->descripcion }}</div>
                                    </td>
                                    <td class="p-3 whitespace-normal">
                                        <div class="text-gray-800">{{ $humana->nivel }}</div>
                                    </td>
                                    <td class="p-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center space-x-4 cursor-pointer">
                                            <a href="{{route('editarHabilidadesHumanas', Crypt::encrypt($humana->id))}}" class="text-blue-600 hover:text-blue-800">Editar</a>
                                            <button wire:click="delete({{ $humana->id }})" class="text-red-600 hover:text-red-800">Eliminar</button>
                                        </div>
                                    </td>
                                </tr>
                            @empty
    ...
    <div class="mt-6 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
        <livewire:portalcapacitacion.habilidadeshumanas.habilidad-humana-table/>
    </div>
