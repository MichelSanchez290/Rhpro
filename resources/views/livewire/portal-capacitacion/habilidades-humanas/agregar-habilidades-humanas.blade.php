        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full sm:w-3/4 md:w-6/5 lg:w-3/2 flex flex-col items-center relative py-12">
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800 text-center uppercase tracking-wide
               ...
               drop-shadow-lg pb-2 border-b-4 border-blue-400 inline-block">
                Agregar Habilidades Humanas
            </h1>
            
            <button onclick="window.location.href='{{ route('mostrarHabilidadesHumanas') }}'"
                ...
                <div class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md z-10">
                    ...
                    <form class="mt-10">
                        ...
                        <div class="mt-7">
                            ...
                            <select wire:model="humana.nivel" id="nivel" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-md bg-gray-100 text-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300 hover:border-blue-400 hover:shadow-lg">
