...
final class DatosAdministradorTable extends PowerGridComponent
{
    public string $tableName = 'datos-administrador-table-0l5cxe-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Datos_Administrador_' . now()->format('Ymd_His')) // Configurar exportación
    ...
    public function actions(Dato $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarDatosAdministrador', ['id' => $row->id]),
                ...
                ->dispatch('confirmarEliminarDatosAdministrador', ['id' => Crypt::encrypt($row->id)]),
        ];
    }
