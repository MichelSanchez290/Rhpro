...
final class CompromisoEmpresaTable extends PowerGridComponent
{
    public string $tableName = 'compromiso-empresa-table-kziun9-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Compromisos_Empresa_' . now()->format('Ymd_His')) // Configurar exportación
    ...
    public function actions(Compromiso $row): array
    {
        return [
            ...
            ->route('editarCompromisoEmpresa', ['id' => $row->id]),
            ...
            ->dispatch('confirmarEliminarCompromisoEmpresa', ['id' => Crypt::encrypt($row->id)]),
        ];
    }
