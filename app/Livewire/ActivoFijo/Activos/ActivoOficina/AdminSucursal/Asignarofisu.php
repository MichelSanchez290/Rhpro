...
class Asignarofisu extends Component
{
    use WithFileUploads;
    ...
    public function mount()
    {
        ...
        $this->activosFiltrados = ActivoOficina::where('sucursal_id', $this->sucursal->id)
            ->where('status', 'Activo')
            ->get();
    ...
    public function asignarActivo()
    {
        ...
        $rutaBase = 'ActivoFijo/Activos/ActivoOficina/Asignaciones/SusursalAdmin';
    ...
    {
        return view('livewire.activo-fijo.activos.activo-oficina.admin-sucursal.asignarofisu')->layout('layouts.navactivos');
    }
}
