...
class Asignarpape extends Component
{
    use WithFileUploads;
    ...
    public function updatedSucursalId($sucursalId)
    {
        ...
        if ($sucursalId) {
            $this->activosFiltrados = ActivoPapeleria::where('sucursal_id', $sucursalId)->get();
    ...
    public function asignarActivo()
    {
        ...
        $rutaBase = 'ActivoFijo/Activos/ActivoPapeleria/Asignaciones/Admin';
    ...
    {
        return view('livewire.activo-fijo.activos.activo-papeleria.admin-admin.asignarpape')->layout('layouts.navactivos');
    }
}
