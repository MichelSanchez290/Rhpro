...
namespace App\Livewire\ActivoFijo\Activos\ActivoMobiliario;
...
class Mostraractmob extends Component
{
    ...
    {
        return view('livewire.activo-fijo.activos.activo-mobiliario.mostraractmob')->layout('layouts.navactivos');
    }
}
