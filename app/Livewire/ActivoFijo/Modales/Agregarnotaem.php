...
class Agregarnotaem extends ModalComponent
{
    ...
    protected function cargarActivosTecnologia()
    {
        ...
        $this->activosTecnologia = ActivoTecnologia::where('empresa_id', $user->empresa_id)->get();
    }
    ...
    public function agregarNotatec()
    {
        ...
        $this->closeModal();
        return redirect()->route('mostrarnotaem');
    }


    public function render()
    {
        return view('livewire.activo-fijo.modales.agregarnotaem');
    }
}
