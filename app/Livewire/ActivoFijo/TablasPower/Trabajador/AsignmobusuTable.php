...
final class AsignmobusuTable extends PowerGridComponent
{
    public string $tableName = 'asignmobusu-table-hd6lvh-table';
    ...
    public function datasource(): Builder
    {
        return DB::table('activos_mobiliario_user')
            ...
            ->where('activos_mobiliario_user.user_id', Auth::id()) // Filtrar por el usuario autenticado
            ->select([
        ...
        return [
            Button::add('delete')
                ...
                ->dispatch('openModal', [
                    ...
                    'arguments' => [
                        'vista' => 'asignaciones-mob-usuario', // Vista única para AdminEmpresa
                        'activo_id' => $row->id
                    ]
                ]),
