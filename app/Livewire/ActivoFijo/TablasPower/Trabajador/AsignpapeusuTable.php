...
final class AsignpapeusuTable extends PowerGridComponent
{
    public string $tableName = 'asignpapeusu-table-8imehe-table';
    ...
    public function datasource(): Builder
    {
        return DB::table('activos_papeleria_user')
            ...
            ->where('activos_papeleria_user.user_id', Auth::id()) // Filtrar por el usuario autenticado
            ->select([
        ...
        return [
            Button::add('delete')
                ...
                ->dispatch('openModal', [
                    ...
                    'arguments' => [
                        'vista' => 'asignaciones-pape-usuario', // Vista única para AdminEmpresa
                        'activo_id' => $row->id
                    ]
                ]),
