...
final class AsigntecusuTable extends PowerGridComponent
{
    public string $tableName = 'asigntecusu-table-qwiup7-table';
    ...
    public function datasource(): Builder
    {
        return DB::table('activos_tecnologia_user')
            ...
            ->where('activos_tecnologia_user.user_id', Auth::id()) // Filtrar por el usuario autenticado
            ->select([
        ...
        return [
            Button::add('delete')
                ...
                ->dispatch('openModal', [
                    ...
                    'arguments' => [
                        'vista' => 'asignaciones-tec-usuario', // Vista única para AdminEmpresa
                        'activo_id' => $row->id
                    ]
                ]),
