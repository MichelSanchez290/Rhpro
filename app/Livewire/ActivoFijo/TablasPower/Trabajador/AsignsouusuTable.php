...
final class AsignsouusuTable extends PowerGridComponent
{
    public string $tableName = 'asignsouusu-table-cxxkov-table';
    ...
    public function datasource(): Builder
    {
        return DB::table('activos_souvenir_user')
            ...
            ->where('activos_souvenir_user.user_id', Auth::id()) // Filtrar por el usuario autenticado
            ->select([
        ...
        return [
            Button::add('delete')
                ...
                ->dispatch('openModal', [
                    ...
                    'arguments' => [
                        'vista' => 'asignaciones-sou-usuario', // Vista única para AdminEmpresa
                        'activo_id' => $row->id
                    ]
                ]),
