...
final class AsignofisuTable extends PowerGridComponent
{
    public string $tableName = 'asignofisu-table-pmtdmv-table';
    ...
    public function actions($row): array
    {
        ...
        Button::add('delete')
            ...
            ->dispatch('openModal', [
                ...
                'arguments' => [
                    'vista' => 'asignaciones-ofi-sucursal', // Vista única para AdminEmpresa
                    'activo_id' => $row->id
                ]
            ]),
        ];
