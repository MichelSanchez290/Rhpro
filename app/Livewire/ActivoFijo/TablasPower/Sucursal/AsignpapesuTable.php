...
final class AsignpapesuTable extends PowerGridComponent
{
    public string $tableName = 'asignpapesu-table-43ognp-table';
    ...
    public function actions($row): array
    {
        ...
        Button::add('delete')
            ...
            ->dispatch('openModal', [
                ...
                'arguments' => [
                    'vista' => 'asignaciones-pape-sucursal', // Vista única para AdminEmpresa
                    'activo_id' => $row->id
                ]
            ]),
        ];
