...
final class AsignmobsuTable extends PowerGridComponent
{
    public string $tableName = 'asignmobsu-table-f4cg29-table';
    ...
    public function actions($row): array
    {
        ...
        Button::add('delete')
            ...
            ->dispatch('openModal', [
                ...
                'arguments' => [
                    'vista' => 'asignaciones-mob-sucursal', // Vista única para AdminEmpresa
                    'activo_id' => $row->id
                ]
            ]),
        ];
