...
class AgregarSucursal extends Component
{
    ...
    protected $rules = [
        ...
        'sucursal.rfc' => 'required|min:12|max:13|unique:sucursales,rfc',
    ...
    protected $messages = [
        ...
        'sucursal.rfc.min' => 'El RFC debe tener al menos 12 caracteres.',
        'sucursal.rfc.max' => 'El RFC no debe exceder los 13 caracteres.',
