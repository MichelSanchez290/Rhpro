...
final class CursoSucursalTable extends PowerGridComponent
{
    ...
    public function datasource(): Builder
    {
        ...
        return Curso::query()
            ...
            )->where('cursos.empresa_id', $user->empresa_id)
            ->where('cursos.sucursal_id', $user->sucursal_id);
    }
    ...
    public function actions(Curso $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarCursosSucursal', ['id' => Crypt::encrypt($row->id)]),
