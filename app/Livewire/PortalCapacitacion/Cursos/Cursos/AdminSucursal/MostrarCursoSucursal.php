...
class MostrarCursoSucursal extends Component
{
    public $showModal = false; // Control para ventana emergente
    public $funcionToDelete;

    public function redirigir(){
        return redirect()->route('agregarCursosSucursal');
    }
    ...
    public function deleteFuncion()
    {
        ...
        return redirect()->route('verCursosSucursal');
    }

    public function render()
    {
        return view('livewire.portal-capacitacion.cursos.cursos.admin-sucursal.mostrar-curso-sucursal')->layout("layouts.portal_capacitacion");
    }
}
