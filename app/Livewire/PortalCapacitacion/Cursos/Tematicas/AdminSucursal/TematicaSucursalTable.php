...
final class TematicaSucursalTable extends PowerGridComponent
{
    ...
    public function datasource(): Builder
    {
        ...
        return Tematica::query()
            ...
            ->where('tematicas.empresa_id', $user->empresa_id) // Filtra por empresa
            ->where('tematicas.sucursal_id', $user->sucursal_id); // Filtra por sucursal
    ...
    public function actions(Tematica $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarTematicasSucursal', ['id' => Crypt::encrypt($row->id)]),
