...
class MostrarCapacitacionesSucursal extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-individuales.admin-sucursal.mostrar-capacitaciones-sucursal', [
