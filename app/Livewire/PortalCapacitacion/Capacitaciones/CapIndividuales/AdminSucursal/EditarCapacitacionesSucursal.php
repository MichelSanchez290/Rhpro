...
class EditarCapacitacionesSucursal extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-individuales.admin-sucursal.editar-capacitaciones-sucursal', [
            'cursos' => $this->cursos,
