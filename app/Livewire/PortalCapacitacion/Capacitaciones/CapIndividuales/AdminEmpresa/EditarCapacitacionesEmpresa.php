...
class EditarCapacitacionesEmpresa extends Component
{
    ...
    public function actualizarCapacitacion()
    {
        ...
        return redirect()->route('verCapacitacionesIndEmpresa', ['id' => $this->usuario_id]);
    }

    public function render()
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-individuales.admin-empresa.editar-capacitaciones-empresa', [
            'cursos' => $this->cursos,
