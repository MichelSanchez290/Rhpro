...
class AgregarCapacitacionesEmpresa extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-individuales.admin-empresa.agregar-capacitaciones-empresa', [
            'cursos' => $this->cursos,
