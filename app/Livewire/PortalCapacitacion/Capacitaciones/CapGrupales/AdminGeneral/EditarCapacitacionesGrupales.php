...
class EditarCapacitacionesGrupales extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-grupales.admin-general.editar-capacitaciones-grupales', [
            'cursos' => $this->cursos,
