...
class MostrarCapacitacionesGrupalesAdminSucursal extends Component
{
    ...
    public function exportarTodasCapacitaciones()
{
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-grupales.admin-sucursal.mostrar-capacitaciones-grupales-admin-sucursal', [
