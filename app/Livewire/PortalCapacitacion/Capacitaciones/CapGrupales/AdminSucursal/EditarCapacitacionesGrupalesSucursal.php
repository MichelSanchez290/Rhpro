...
class EditarCapacitacionesGrupalesSucursal extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.capacitaciones.cap-grupales.admin-sucursal.editar-capacitaciones-grupales-sucursal', [
            'cursos' => $this->cursos,
