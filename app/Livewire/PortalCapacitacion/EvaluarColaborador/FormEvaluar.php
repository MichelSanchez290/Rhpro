...
namespace App\Livewire\PortalCapacitacion\EvaluarColaborador;
...
class FormEvaluar extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.evaluar-colaborador.form-evaluar')
